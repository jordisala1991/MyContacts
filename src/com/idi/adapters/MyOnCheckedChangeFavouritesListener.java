...
public class MyOnCheckedChangeFavouritesListener implements OnCheckedChangeListener
{
	...
	public MyOnCheckedChangeFavouritesListener(Context context, int contactId, int position)
	{
